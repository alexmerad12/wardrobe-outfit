...
--
-- APPLIED 2026-06-13 (owner ran it in the SQL editor; DB_FEATURE.refine
-- flipped in src/lib/log-ai-call.ts the same day). Historical refine
-- rows remain feature='suggest' with metadata->>'kind' = 'refine';
