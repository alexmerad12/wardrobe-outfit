...
import {
  ...
  BAG_SIZE_LABELS,
  BAG_TEXTURE_LABELS,
  SUNGLASSES_STYLE_LABELS,
  HAT_SILHOUETTE_LABELS,
  JEWELRY_SCALE_LABELS,
  SCARF_FUNCTION_LABELS,
  SKIRT_LENGTH_LABELS,
...
export function useLabels() {
  ...
  return useMemo(() => {
    ...
    return {
      ...
      BAG_TEXTURE: mapKeys<BagTexture>(BAG_TEXTURE_LABELS, "bagTexture"),
      SUNGLASSES_STYLE: mapKeys<SunglassesStyle>(SUNGLASSES_STYLE_LABELS, "sunglassesStyle"),
      HAT_SILHOUETTE: mapKeys<HatSilhouette>(HAT_SILHOUETTE_LABELS, "hatSilhouette"),
      JEWELRY_SCALE: mapKeys<JewelryScale>(JEWELRY_SCALE_LABELS, "jewelryScale"),
      SCARF_FUNCTION: mapKeys<ScarfFunction>(SCARF_FUNCTION_LABELS, "scarfFunction"),
      SKIRT_LENGTH: mapKeys<SkirtLength>(SKIRT_LENGTH_LABELS, "skirtLength"),
      DRESS_SILHOUETTE: mapKeys<DressSilhouette>(DRESS_SILHOUETTE_LABELS, "dressSilhouette"),
      TOE_SHAPE: mapKeys<ToeShape>(TOE_SHAPE_LABELS, "toeShape"),
