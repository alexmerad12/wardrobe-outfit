...
- jewelry_scale (only for category="accessory" and subcategory="jewelry"): "minimal" | "statement". Minimal = thin chain necklace, simple stud earrings, dainty ring, slim bracelet — barely-there jewelry that disappears on the body. Statement = chunky chain, oversized hoops, large pendant, cocktail ring, layered cuffs — eye-grabbing. Default to "minimal" when unsure.
