...
const AUTH_CSS = `
  ...
  .auth-vignette {
    position: absolute; inset: 0;
    background:
      radial-gradient(ellipse at 50% 30%, rgba(235,224,200,0.7) 0%, transparent 60%),
      radial-gradient(ellipse at center, transparent 55%, rgba(58,42,30,0.28) 100%);
    pointer-events: none;
  }
  ...
  .auth-card {
    ...
    background: rgba(248,239,214,0.92);
    border: 0.5px solid rgba(10,8,6,0.16);
    border-radius: 18px;
    ...
    box-shadow:
      ...
      0 12px 36px rgba(58,42,30,0.18);
    color: #0a0806;
  }
  ...
  .auth-card input[type="text"] {
    ...
    border: 0.5px solid rgba(10,8,6,0.22);
    border-radius: 10px;
    padding: 11px 12px;
    font: inherit;
    color: #0a0806;
  ...
  .auth-card .auth-link {
    color: #0a0806;
    font-weight: 500;
    border-bottom: 0.5px dotted rgba(10,8,6,0.4);
    text-decoration: none;
  }
  .auth-card .auth-link:hover { border-bottom-color: #0a0806; }
  ...
  .auth-card .auth-terms {
    ...
    border-top: 0.5px solid rgba(10,8,6,0.16);
